// components/checkout/ConfirmationPage.tsx
    ...
    <div className='space-y-8'>
      ...
      >
        <div className='flex items-center justify-between mb-6'>
          ...
          <span className='text-sm text-gray-600'>
            Total Items:{" "}
            {orderSummary.items.reduce((acc, item) => acc + item.quantity, 0)}
          </span>
        </div>
        <div className='space-y-4'>
          <AnimatePresence>
      ...
      >
        {orderActions.map((action, index) => (
          ...
          >
            <div
              className='w-12 h-12 bg-gradient-to-br from-orange-100 to-orange-50 
