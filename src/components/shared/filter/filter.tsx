...
import { AccordionProps, CheckboxProps, ProductFilterProps, SliderProps } from "../types/filterTypes";
...
const CustomSlider: React.FC<SliderProps> = ({
  ...
  const handleInteraction = useCallback(
    (clientX: number) => {
      ...
      const newValue =
        Math.round(((max - min) * percentage) / step) * step + min;
    ...
    <div className='relative py-4'>
      ...
      >
        ...
        >
          {showTooltip && (
            <div
              className='absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white 
